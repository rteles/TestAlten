...
namespace Alten.Booking.Infra.Data.Sql.Migrations
{
    ...
    [Migration("20230118014737_AddBooking")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alten.Booking.Infra.Data.Sql.Context.Bookings.Models.BookingModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Alten.Booking.Infra.Data.Sql.Context.Users.Models.UserModel", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Active = true,
                            BirthDate = new DateTime(1990, 1, 17, 0, 0, 0, 0, DateTimeKind.Local),
                            Cpf = "066.114.819-07",
            ...
            modelBuilder.Entity("Alten.Booking.Infra.Data.Sql.Context.Bookings.Models.BookingModel", b =>
                {
                    b.HasOne("Alten.Booking.Infra.Data.Sql.Context.Hotels.Models.RoomModel", "Room")
                        .WithMany("Bookings")
                        .HasForeignKey("RoomId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Alten.Booking.Infra.Data.Sql.Context.Users.Models.UserModel", "User")
                        .WithMany("Bookings")
